...
const tracks = [
  {name:'Dhaker Taley', artist:'Traditional • Community Archive', dur:'3:12', src:'sounds/dhaker-taley.mp3'},
  {name:'elo je Maa', artist:'Field Recording', dur:'4:00', src:'sounds/elo-je-maa.mp3'},
  {name:'Amar DUGGA', artist:'Temple Recording', dur:'3:45', src:'sounds/amar_dugga.mp3'},
  {name:'Sandhya Aarti', artist:'Traditional', dur:'9:00', src:'sounds/sandhya-aarti.mp3'},
  {name:'Chandi Path', artist:'Birendra Krishna Bhadra', dur:'30:15', src:'sounds/chandi-path.mp3'},
];
...
const miniBar        = miniPlayer.querySelector('.bar');
const miniBarFill    = miniPlayer.querySelector('.bar i');
...
function handleSubmit(formEl, msgId, captchaAnsRef, kind, resetCaptcha){
  formEl.addEventListener('submit', (e)=>{
    ...
    addHidden(formEl, '_subject',  `Puja Heritage — new ${kind} submission`);
